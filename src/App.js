...
const getBalances = async (cbal, callback) => {
    if (localStorage.getItem("ic-delegation")) {
        ...
        let b = await actor.account_balance({'account': fromHexString(principalToAccountIdentifier(authClient.getIdentity().getPrincipal().toText(), 0))})
...
const App = () => {
  ...
  if (address && (nfts === null) && (stakedPairs === null) && (balances === null) && refresh) {
  ...
  return (
      <Router>
        <Routes>
          ...
          <Route path="/demo" element={<Demo address={address} setAddress={setAddress} nfts={nfts} setNfts={setNfts} setTask={setTask} balances={balances} setBalances={setBalances}/>} />
          <Route path="/play" element={<Play address={address} setAddress={setAddress} nfts={nfts} setNfts={setNfts} setTask={setTask} balances={balances} setBalances={setBalances}/>} />
          <Route path="/wallet" element={<Wallet address={address} setAddress={setAddress} nfts={nfts} setNfts={setNfts} setTask={setTask} balances={balances} setBalances={setBalances}/>}/>
          <Route path="/stake" element={<Stake address={address} setAddress={setAddress} nfts={nfts} setNfts={setNfts} stakedPairs={stakedPairs} setStakedPairs={setStakedPairs} setRefresh={setRefresh} task={task} setTask={setTask} balances={balances} setBalances={setBalances}/>} />
          <Route path="/market" element={<Market address={address} nfts={nfts} setNfts={setNfts} setTask={setTask} balances={balances} setBalances={setBalances}/>} />
        </Routes>
      </Router>
  );
}
